 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.service.example.com/", wsdlLocation = "http://127.0.0.1:3333/webservice/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:3333/webservice/hello?wsdl");
