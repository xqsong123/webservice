...
public class ObjectFactory {
    ...
    private final static QName _Greet_QNAME = new QName("http://service.example.com/", "greet");
    private final static QName _GreetResponse_QNAME = new QName("http://service.example.com/", "greetResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.com/", name = "greet")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.com/", name = "greetResponse")
